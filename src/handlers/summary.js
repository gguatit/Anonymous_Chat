...
8. 무슨 이야기를 했는지 3~5문장의 자연스러운 문단으로 설명하세요. 절대로 글머리 기호나 "주제:" 같은 형식을 사용하지 마세요.
9. 각 대화 주제를 구체적으로 언급하고, 누가 어떤 의견을 냈는지 흐름을 따라가며 서술하세요.
   "00에 대한 이야기로 시작해서 00이 00를 추천했고, 이후에는 00에 대한 농담이 오갔어" 같은 식으로.
10. "주제 없음", "없음" 같은 모호한 표현은 절대 사용하지 마세요. 대화가 적더라도 있는 내용을 구체적으로 쓰세요.`,
...
9. 분위기의 세부 요소를 아래 각각 한 문장씩, 총 4문장으로 설명하세요:
...
11. 절대로 숫자나 점수로 표현하지 마세요. 문장으로만 표현하세요.`,
